...
export class PersonalInfoService {
  personalInfo: PersonalInfo = {
    ...
    jobs: [
      {
        ...
        jobDescription:
          `Entered as Junior Software Developer designing and creating platforms but after months,
      ...
      },
      {
        ...
        jobDescription:
          `My first contact with applied technology as a professional was installing,
            updating and managing Smart Boards. Devices which I installed at schools
            and companies. Also I was in charge of giving support to clients and
            prospects, shaping offers and designing
    ...
    hobbies: `Reading tech articles (Machine Learning, AI, Aerospacial, Cience, Web Development),
              poetry, sci-fi, history about Mexico, go cycling (about 2 years ago),
    ...
    skills: [
      'Respectful', 'Organized', 'Communicative', 'Commited', 'Responsible', 'Friendly', 'Leader'
    ],
    socialMedia: {
    ...
    volunteer: [
      ...
      },
      {
        ...
        description: `One of the most important event in Baja for showcasing technology
                      and industry potential of Baja California to the world,
                      known as a massive event where nearly 5000 persons attend
                      per day with a duration of two full weeks of workshops, exhibitions and talks
                      with the participation of characters like Steve Wozniak (Co-founder of Apple),
                      Blake Mycoskie (ex CEO of Toms), and many more. I was in charge of the technical
                      area, coordinating the camera persons, switching slides, coordinating lights,
                      making sure every device in the theater was working correctly.`,
        date: '2012'
      }
    ],
    years: '23'
